import {Token, AbstractSyntaxTree} from "../../common/common.mjs";

import {ParsingTable, ShiftEntry, ReduceEntry, AcceptEntry} from "./ParsingTable.mjs";

/** A table-driven syntax implementing the LR parsing algorithm. Parses input in O(N) time */
export class LRParser {
    /** @type {ParsingTable} */
    #table;

    /**
     * Makes a syntax given a {@link ParsingTable}
