...
import {Rule} from "../ParseRule.mjs";
import {SymbolString} from "../SymbolString.mjs";
import {SymbolSet} from "../parser_generator/SymbolSet.mjs";
import {SMap} from "../../util/FMap.mjs";
...
export class Grammar {
    ...
    constructor(rules, startSymbol) {
        ...
        // Augment the grammar
        this.#startRule = new Rule(JSymbol.__START__, new SymbolString(startSymbol), false, true);
